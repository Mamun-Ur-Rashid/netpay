    ...
    return (
        <div className='container mx-auto  md:my-12 pt-14'>
            ...
            <div className='md:flex justify-between mt-4 md:mt-10 gap-9 '>
                <div className='w-full md:w-1/3  px-4 py- md:py-0 bg-[#1B2654] h-96 rounded'>
                ...
                <div className='w-full md:w-1/3 px-4 md:py-0 bg-[#1B2654] h-96 rounded'>
                    <div className='text-center p-4 text-white '>
                ...
                <div className='w-full md:w-1/3 px-4 mb-10 md:py-0 bg-[#1B2654] rounded h-[400px] md:h-96'>
                    <div className='text-center p-4 text-white'>
