    ...
    return (
        <div>
            <div >
                ...
                <p className="mt-1 text-sm md:text-xl text-center text-white">Our services are designed to make your rregular financial  transactions convenient and easy</p>
            </div>
            <div>
