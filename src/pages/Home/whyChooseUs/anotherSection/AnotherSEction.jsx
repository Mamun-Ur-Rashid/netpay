...
const AnotherSEction = () => {
    return (
        <div className="bg-[#1B2654] mt-20 md:flex">
            ...
            <div className="w-1/2 px-8 md:py-10 ">
                <h1 className="text-white text-center text-xl md:text-4xl">Securely send your money and get online shoping using NetPay.</h1>
